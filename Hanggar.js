 ...
 */
 ...
 if (process.argv.length < 5){console.log(`Usage: node Hanggar.js URL TIME REQ_PER_SEC THREADS\nExample: node Hanggar.js https://tls.mrrage.xyz 500 8 1`); process.exit();}
